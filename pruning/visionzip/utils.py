...
from llava.model.multimodal_encoder.clip_encoder import CLIPEncoderLayer
...
def apply_info(model):
    ...
    model.r = [0 for _ in range(num_layers - 1)] + [1]

    model._info = {
        "r": model.r,
    }
    for module in model.modules():
        if isinstance(module, (SigLipEncoderLayer, CLIPEncoderLayer)):
